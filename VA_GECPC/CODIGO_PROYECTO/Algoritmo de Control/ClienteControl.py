...
class ClienteControl(object):
    ...
    def __init__(self, resolucion, tiempo_captura, direccion_servidor, framerate):
        ...
        # Se definen las variables globales resolucion y tiempo_captura.
...
if __name__ == '__main__':
    cliente_ctrl = ClienteControl((320, 240), 600, ('192.168.0.100', 8000), 10)
    cliente_ctrl.iniciar_streaming()
